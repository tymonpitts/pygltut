...
with open(os.path.join(dirname, "data","FragPosition.vert"),'r') as myfile:
    VERTEX_SHADER = myfile.read()
with open(os.path.join(dirname, "data","FragPosition.frag"),'r') as myfile:
...
class Tutorial(AbstractTutorial):
    ...
    def display(self):
        ...
        GL.glDrawArrays(GL.GL_TRIANGLES, 0, len(self.vertexPositions)//self.num_vertex_components)
